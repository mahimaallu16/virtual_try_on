                ...
                <div className="shoppingBagTotal">
                  ...
                  <table className="shoppingBagTotalTable">
                    <tbody>
                      <tr>
                        <th>Subtotal</th>
                        <td>${Number(totalPrice || 0).toFixed(2)}</td>
                      </tr>
                      <tr>
                        <th>Shipping</th>
                        <td>
                          <div className="shoppingBagTotalTableCheck">
                            <p>${Number(totalPrice === 0 ? 0 : 5).toFixed(2)}</p>
                            <p>Shipping to Al..</p>
                            <p
                              onClick={scrollToTop}
                              style={{
                      ...
                      <tr>
                        <th>VAT</th>
                        <td>${Number(totalPrice === 0 ? 0 : 11).toFixed(2)}</td>
                      </tr>
                      <tr>
                        <th>Total</th>
                        <td>
                          ${Number(totalPrice === 0 ? 0 : totalPrice + 16).toFixed(2)}
                        </td>
                      </tr>
                    </tbody>
                  </table>
                      ...
                      <table>
                        <tbody>
                          ...
                          <tr>
                            ...
                            <td>
                              $
                              {Number(totalPrice === 0 ? 0 : totalPrice + 16).toFixed(
                                2
                              )}
                            </td>
                          </tr>
              ...
              <div className="orderCompleteSection">
                <div className="orderComplete">
                  ...
                  <div className="orderInfo">
                    ...
                    <div className="orderInfoItem">
                      <p>Total</p>
                      <h4>${Number(totalPrice || 0).toFixed(2)}</h4>
                    </div>
                    <div className="orderInfoItem">
                      <p>Payment Method</p>
