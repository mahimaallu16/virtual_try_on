            ...
            {activeTab === "aiTab1" && (
              <div className="aiTabDescription">
                <div className="descriptionPara">
                  <h3>How to use</h3>
                  <p>
                    To use this product, follow these steps: first, ensure you have all the necessary materials. Next, carefully read the instructions provided to understand the assembly process. If you encounter any difficulties during assembly, refer to the troubleshooting section for guidance. After assembly, your product is ready for use. Please note that improper use or failure to follow instructions may result in damage to the product or personal injury.
                  </p>
                </div>
                  ...
                  <div className="userReviews">
                    ...
                    >
                      ...
                      <div className="userReviewContent">
                        ...
                        >
                          <p>
                            Free time, when our power of choice is untrammelled and when nothing prevents us from doing what we like best, every pleasure is to be welcomed…
                          </p>
                        </div>
                      </div>
                    </div>
