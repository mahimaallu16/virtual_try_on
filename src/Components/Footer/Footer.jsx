      ...
      <footer className="footer">
        <div className="footer__container">
          <div className="footer_left">
            ...
            <p>Beach Road, Visakhapatnam, Andhra Pradesh, India</p>

            <div className="footer_address">
              <strong> admin@FitFusionmail.com </strong>
              <strong> +91987654321 </strong>
            </div>
        ...
        <div className="footer_bottom">
          <p>
            © {getCurrentYear()} FitFusion. All Rights Reserved | Made By{" "}
            <a
              href=""
              target="_blank"
              rel="noreferrer"
